...
export const BANTER_PHRASES = [
  ...
  'מנשה יגיע השבוע? או שזה שוב חירום "בעבודה". 🏃',
  'אנטוני מסתובב על הדשא — הסיבוב הכי יפה בליגה, רק בלי שער. 💫',
  'המנכ״ל מחלק הוראות ומסמן ימים — הפועלים על המגרש. 📋',
  'הרמקול נשמע כבר מהלובי — המשחק עוד לא נפתח. 📣',
  'הקיר שלו חזק — רק השער הזה מתחמק כל שבת. 😎',
  'המילואימניק חוזר ואומר "על המגן" — ואז בולם את עצמו. 🤫',
  'כלל לא כתוב: מי שמפסיד מביא וויסקי. קבלו את הבקבוק. 🥃',
  'הנסיך על הכס מחכה לגול — הכס מתחיל להתבזבז. 🤴',
  'שער שהיה — היה. שלא — אל תגלו לוויסקי. ⚽',
  // Fresh cuts from whatsapp-group.txt: the whiskey ledger, the boss's
  // Thailand trip, the Cameroon trips of whoever never shows up.
  ...
  'מנשה שחרר את הרצועה — או שכבר בקובה? רגע, אז בכלל לא. 🪢',
  'אין ספק, רק שאלה: מי שזוכר את השער של אסף? גם הוא לא. 😴',
  'אבי י מסדר את הטורניר, את הקופה ואת כולם — רק את הגול שלו אי אפשר לסדר. 🧭',
  'אם רשמתם את המשחק מראש, הבוט ימצמץ לכם — ואם לא, שום וואלה לא עוזר. ⚽',
  'המנגל כבר על האש — כולם באו, כולם דיברו, אף אחד לא היכה. בדיוק כמו קובה. 🍖',
]
