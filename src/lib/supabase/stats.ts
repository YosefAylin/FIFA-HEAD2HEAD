...
export const BANTER_PHRASES = [
  'כלל ברזל: מי שמפסיד מביא וויסקי — בלי תירוצים 🥃',
  'השמועה אומרת שמישהו כבר פתח את הוויסקי של אתמול... 🍾',
  'הקובה של שבת מתחילה — חטיפים ובירות מוכנים 📺',
  'זקי דאג לכולם בלי בלאגן — רגוע, זה הסטייל שלו 😎',
  'ליאור איש המילואים חוזר — הכדור מחכה לו בעלייה ⚽',
  'אשגרה חייב וויסקי כבר תקופה — השמועה מתחזקת 🥃',
  'המנכ"ל יוסי ניצב בראש הטורניר — מלוא העוצמה 📣',
  'אסף משחק כמו ברסה 👀 — לפעמים יותר מדי',
  'לא מפסידים פעמיים — המפסיד מפצה בשבוע הבא 🥃',
  'שולחן יודע חוקים: מי שלא מכיר בחוקים חי ✍️',
]
