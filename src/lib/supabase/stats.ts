...
export const BANTER_PHRASES = [
  'הכלל היחיד בקובה: מי שמפסיד מביא וויסקי — וליאור חייב משנתיים. 🥃',
  'ליאור שוב במילואים? גם היום "על המגן" — ועדיין לא ראה את הרשת. 🎖️',
  'אשגרה מתחמק מתשלום, מתחמק מפנדלים, ומתחמק מהניקיון במקפיא. 🤑',
  'מנש יוצא מהקובה ישר אל איצקו — עוד צלחת, עוד שוט, עוד חוב לוויסקי. 🍼',
  'זקי הפיל שלט — טיסה יותר ארוכה מכל שער שלו השבוע. 💨',
  'המנכ״ל ספי מריץ את הליגה — הגביע עוד מחכה במילואים. 📋',
  'קובה לא נפתחה עד שספי הכריז "יש מנהל". ככה זה כשהוא מפזר חוקים. 📣',
  'אבי מנתח את הכדור זהב כמו רודרי — אם רק היה יודע לבקוע. 🧭',
  'זקי שותק, זקי רגוע — ואז השלט עף. אל תתנו לו להפסיד פעמיים. 🤫',
  'אשגרה שומר על המקפיא — אבל אם יש שאריות טובות, פתאום הן שלו. ❄️',
  'אישור מהאישה? מצו מעצר לדלת. לא מגיע — הבית נסגר, אין כניסה. 🏡',
  'הוראה ראשונה: לא לגעת בשלט של זקי. הוראה שנייה: שמישהו יביא כבר וויסקי. 🫣',
  'יוסף בוכה על המילואים — אבל כשצריך להחליף משמרת, פתאום הוא פנוי. 😭',
  'חוקי הקובה: לוזר מביא וויסקי, המנכ״ל מתחמק, והמפקד מטגן את כולם בשלט. 🥂',
  'בעל הבית בתאילנד — הפועלים דופקים על הדשא, הוא על החופים. ✈️',
  'מנשה במטבח, אשגרה במקפיא, ליאור במילואים — והכל על הראש של ספי. 🧉',
  'מי לקח מהפוך מיוסף השבוע? מגיע לו — סופסוף מישהו שובר לו את הגאווה. 👊',
  'הקובה רצה — הנרגילה בשטח, והסקורים מגיעים היישר מהעשן. 🚬',
  'רשמתם את המשחק? ספי כבר רשם את הנצחון שלו — על הנייר תמיד הוא מנצח. 📍',
  'צו מעצר למי שלא בא עם וויסקי — זה החוק הראשון של הליגה. 🚨',
]
