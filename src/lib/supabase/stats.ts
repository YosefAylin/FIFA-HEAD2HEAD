...
export const BANTER_PHRASES = [
  'כלל שאינו כתוב: מי שמפסיד מביא וויסקי — בלי תירוצים 🥃',
  'אשגרה עוד חייב וויסקי מהחודש שעבר — הדבר הכי בטוח בקבוצה 🥛',
  'ספי סידר את הטורניר מהספסל — מישהו כבר מדווח על הפחד 🎤',
  'הקובה של שבת מתחילה — חטיפים, בירות, ושלטים שאסור לפספס 📺',
  'עקיצה: שער שהיה — היה, שלא — אל תגלו לוויסקי ⚽',
  'פילוסופיה: מי שסוגר השער הוא אלוף — מי שסוגר את הפה יושב',
]
