...
/** Rotating group banter phrases (in Hebrew). */
export const BANTER_PHRASES = [
  'מי יביא את הוויסקי השבוע? 🥃',
  'מי ינצח את יוסף? 🤔',
  'מתי מנשה כבר יגיע? ⏰',
  'מגיע לכם, מגיע! 🏆',
  'הקובה של שבת זה הדבר האמיתי 🔥',
  'הערבים נגמרים, החשבון עוד חי 👀',
  'גיבורים לא בוכים, אבל שופטים צועקים 🧐',
  'שער אחד מורידים, שניים מוסיפים 🥅',
  'חג שמח של ניצחונות 🎉',
  'אל תזלזלו בבעיטות העונשין 🚀',
]
